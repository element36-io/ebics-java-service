...
public class PainCH implements Pain {
    ...
    public JAXBElement<Document> generatePainFile(String msgId, String pmtInfId, String sourceIban, String sourceBic,
            BigDecimal amount, String currency, String receipientIban, String receipientBankName,
            String recipientBankPostAccount, String receipientName, String purpose, String ourReference,
            String receipientStreet, String receipientStreetNr, String receipientZip, String receipientCity,
            String receipientCountry, String clearingSystemMemberId, boolean nationalPayment)
        ...
        groupHeader32CH.setCreDtTm(new EbicsTools().getXmlGregorianCalendarDate("yyyy-MM-dd'T'HH:mm:ss"));
        groupHeader32CH.setNbOfTxs("1");
        groupHeader32CH.setCtrlSum(amount);

        PartyIdentification32CHNameAndId partyIdentification32CHNameAndId = new PartyIdentification32CHNameAndId();
        ...
        // Execution Date
        paymentInstructionInformation3CH.setReqdExctnDt(new EbicsTools().getXmlGregorianCalendarDate("yyyy-MM-dd"));
        ...
        BranchAndFinancialInstitutionIdentification4CHBicOrClrId branchAndFinancialInstitutionIdentification4CHBicOrClrId = new BranchAndFinancialInstitutionIdentification4CHBicOrClrId();
        ...
        branchAndFinancialInstitutionIdentification4CHBicOrClrId
                .setFinInstnId(financialInstitutionIdentification7CHBicOrClrId);
        // Update main object
        paymentInstructionInformation3CH.setDbtrAgt(branchAndFinancialInstitutionIdentification4CHBicOrClrId);
        ...
        if (nationalPayment) {
            ...
            localInstrument2Choice.setPrtry("CH03"); // Payment Type using IBAN, National, Art 2.2 aak Spec
        ...
        AccountIdentification4ChoiceCH accountIdentification4ChoiceCH1 = new AccountIdentification4ChoiceCH();
        ...
        if (nationalPayment) {
            // Update main object - C-LEVEL
            BranchAndFinancialInstitutionIdentification4CH branchAndFinancialInstitutionIdentification4CH = new BranchAndFinancialInstitutionIdentification4CH();
            FinancialInstitutionIdentification7CH financialInstitutionIdentification7CH = new FinancialInstitutionIdentification7CH();
            ...
            branchAndFinancialInstitutionIdentification4CH.setFinInstnId(financialInstitutionIdentification7CH);
            creditTransferTransactionInformation10CH.setCdtrAgt(branchAndFinancialInstitutionIdentification4CH);
        }
